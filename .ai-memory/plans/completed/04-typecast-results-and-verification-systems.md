...
- [`.ai-memory/strictly-avoid.md`](.ai-memory/strictly-avoid.md) — Prohibition of generic `Interface` suffixes on Go interfaces; strict enforcement of idiomatic `-er` naming and `Checker` suffixes.
