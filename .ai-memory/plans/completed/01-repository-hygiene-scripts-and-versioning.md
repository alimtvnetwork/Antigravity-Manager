...
- [`.ai-memory/memory/01-index.md`](.ai-memory/memory/01-index.md) — Memory record of prompt architect version tracking, author attribution requirements, and encoding safeguards.
- [`.ai-memory/strictly-avoid.md`](.ai-memory/strictly-avoid.md) — Total ban on absolute file paths, uppercase acronym ID naming, and unmanaged version tampering.
