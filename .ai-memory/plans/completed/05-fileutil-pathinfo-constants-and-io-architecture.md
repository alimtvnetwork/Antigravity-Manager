...
- [`.ai-memory/strictly-avoid.md`](.ai-memory/strictly-avoid.md) — Total bans on `mu` naming, non-prefixed booleans, string concatenation for paths, and process-spawning env expanders.
