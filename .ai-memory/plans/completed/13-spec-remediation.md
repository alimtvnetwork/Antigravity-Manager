...
1. `.ai-memory/plans/subtasks/13-spec-fix/01-fix-spec-index-and-guidelines.md` (F-002, F-003, F-010)
2. `.ai-memory/plans/subtasks/13-spec-fix/02-fix-ipc-registry-and-frontend.md` (F-001, F-008, F-009)
3. `.ai-memory/plans/subtasks/13-spec-fix/03-fix-testing-and-acceptance-criteria.md` (F-004, F-005)
4. `.ai-memory/plans/subtasks/13-spec-fix/04-fix-cicd-and-consolidated-mirrors.md` (F-006, F-007)
