...
- **Target Files:** `version.json`, `package.json`, `src-tauri/Cargo.toml`, `src-tauri/tauri.conf.json`, `CHANGELOG.md`, `CHANGELOG_EN.md`, `.ai-memory/release/release-notes-v4.14.0.md`
- **Accomplishments:**
