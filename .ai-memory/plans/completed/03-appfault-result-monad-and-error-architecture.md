...
| 2 | Boolean Ban RCA | Added total ban on `== true` / `=== true` across specs and prompts | `.ai-memory/strictly-avoid.md`, `02-spec/` | DONE |
...
- [`.ai-memory/strictly-avoid.md`](.ai-memory/strictly-avoid.md) — Root cause analysis on boolean check hallucinations and ban on explicit `== true`.
