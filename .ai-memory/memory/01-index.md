...
- [Refresh Token Capture, Multi-Instance & Window Specs](learned/13-refresh-token-capture-multi-instance-and-window-specs.md) — Token extraction pathways, multi-instance profile sandboxing (--user-data-dir), and window identity title customization.
- [Comprehensive Project Context & v4.14.0 Ingestion Memory](learned/14-comprehensive-project-context-and-v4-14-0-state.md) — Ingestion of repository identity, last 10 git commits, CODE RED rules, coding guidelines, error philosophy, active plans, and runtime compatibility.
- [v4.17.0 Architecture, SQLite Tool Signatures & Test Resilience](learned/15-v4-17-0-architecture-sqlite-tool-signatures-and-test-resilience.md) — Ingestion of v4.17.0 release state, SQLite L2 tool signatures, 17 CI/CD RCAs, last 10 git commits, and CODE RED rules.
