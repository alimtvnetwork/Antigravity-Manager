        ...
        <div className="space-y-3">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div className="space-y-0.5">
                        ...
                        <p className="text-[10px] text-gray-500 dark:text-gray-400">
                            {t("settings.image_thinking_mode.hint", { defaultValue: "Affects image quality and generation workflow" })}
                        </p>
                    </div>
                </div>
                    ...
                    {options.map((option) => (
                        ...
                        >
                            {t(`settings.image_thinking_mode.options.${option.label}`, {
                                defaultValue: option.value === 'enabled' ? "Enabled" : "Disabled"
                            })}
                        </button>
                    ))}
                </div>
            ...
            <div className="px-1">
                <p className="text-[10px] text-gray-400 dark:text-gray-500 italic leading-relaxed">
                    {value === 'enabled'
                        ? t("settings.image_thinking_mode.options.enabled_desc", { defaultValue: "Enabled: Retains thought process, returning both sketch and final image." })
                        : t("settings.image_thinking_mode.options.disabled_desc", { defaultValue: "Disabled: Disables thought process, directly generating single ultra-high-definition image (quality prioritized)." })
                    }
                </p>
            </div>
        </div>
