...
3. [ ] **Phase 1: Remediation Ledger:** Create `.lovable/plans/pending/xx-spec-remediation.md` with explicit checkboxes for each finding.
4. [ ] **Phase 1: Subtask Decomposition:** Write lean subtasks to `.lovable/plans/subtasks/xx-spec-fix/01-<slug>.md`.
