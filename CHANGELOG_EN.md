...
*   **Version History**:
    *   **v4.71.2 (2026-09-24)**:
        -   **[Release v4.71.2: RFC 2045 Base64 Dual-Part HTML Email Cards, Mandatory `[VM_ALIAS | LOCAL_IP]` Subject Prefix, Smart Rotator & Default IDE Switch Pipeline Unification, and Settings Hamburger Menu] Complete Elimination of Raw HTML Tag Leakage & Gmail Folding, Highlighted `⇄` Switch Button Parity, and Secondary Settings Hamburger Dropdown**:
            ...
            -   **Root Cause Analysis**: Published `02-spec/22-app-issues/05-email-html-rendering-and-smart-rotator-ide-switch-rca.md`.
