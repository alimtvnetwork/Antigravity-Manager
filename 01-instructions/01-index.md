...
> Master index and reference map for Antigravity-Manager runtime architecture, token extraction pipelines, multi-instance orchestration, window customization, and auto-rotation.
...
| [08-automated-quota-polling-profile-switching-and-task-resumption.md](08-automated-quota-polling-profile-switching-and-task-resumption.md) | Background timer polling (60s default), low-quota threshold auto-switching (<10%), best profile selection, pending QE task state snapshot, and automated resumption | AI Agents, Systems Architects |
