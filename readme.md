...
<p align="center">
  ...
  <a href="https://github.com/alimtvnetwork/Antigravity-Manager/releases">
    <img src="https://img.shields.io/badge/Version-4.46.0-3B82F6?style=flat-square" alt="Version 4.46.0">
  </a>
...
```powershell
# Install pinned release (e.g. v4.46.0)
irm https://github.com/alimtvnetwork/Antigravity-Manager/releases/download/v4.46.0/install.ps1 | iex
```

#### Linux & macOS (Bash)
```bash
# Install pinned release (e.g. v4.46.0)
curl -fsSL https://github.com/alimtvnetwork/Antigravity-Manager/releases/download/v4.46.0/install.sh | bash
```
