...
<p align="center">
  ...
  <a href="https://github.com/alimtvnetwork/Antigravity-Manager/releases">
    <img src="https://img.shields.io/badge/Version-4.63.0-3B82F6?style=flat-square" alt="Version 4.63.0">
  </a>
  ...
  <img src="https://img.shields.io/badge/Platforms-Linux%20|%20macOS%20|%20Windows-8B5CF6?style=flat-square" alt="Cross-Platform">
  <img src="https://img.shields.io/badge/License-CC--BY--NC--SA--4.0-10B981?style=flat-square" alt="License CC BY-NC-SA 4.0">
  <!-- STAMP:PLATFORM_BADGES -->
</p>

<p align="center">
  <img src="https://img.shields.io/badge/Architecture-Multi--Instance%20Isolated-14B8A6?style=flat-square" alt="Multi-Instance Isolation">
  <img src="https://img.shields.io/badge/Ubuntu%20Healing-storage.json%20Auto--Gen-0EA5E9?style=flat-square" alt="Ubuntu Auto-Healing">
  <img src="https://img.shields.io/badge/Protocols-OpenAI%20|%20Anthropic%20|%20Gemini-EC4899?style=flat-square" alt="Multi-Sink Protocols">
  <img src="https://img.shields.io/badge/AI%20Ready-Error%20Management%20Integrated-F59E0B?style=flat-square" alt="Error Management">
  <a href="https://trendshift.io/repositories/18224" target="_blank" rel="noopener noreferrer">
    <img src="https://trendshift.io/api/badge/repositories/18224" alt="Trendshift Popularity" height="20"/>
  </a>
</p>
...
| :---: | :---: |
| ![Dashboard - Quota Monitoring & Instant Switch](docs/images/dashboard-light.png)<br><sub><b>Smart Dashboard</b>: Real-time quota metrics (Gemini Pro, Flash, Claude, Imagen 3) with intelligent recommendation</sub> | ![Accounts List - Multi-Account Management](docs/images/accounts-light.png)<br><sub><b>Account Inventory</b>: High-density token view, active account badges, and automatic 403 anomaly isolation</sub> |
...
| :---: | :---: |
| ![Claude Code Web Search](docs/images/usage/claude-code-search.png)<br><sub>Structured web citations and reasoning chain output in Claude Code</sub> | ![Cherry Studio Integration](docs/images/usage/cherry-studio-citations.png)<br><sub>Native search citations, token streaming, and citation cards in Cherry Studio</sub> |
| **Imagen 3 Ultra-HD Image Generation** | **Kilo Code Cross-Account Penetration** |
| ![Imagen 3 Advanced Image Generation](docs/images/usage/image-gen-nebula.png)<br><sub>Prompt-faithful multi-ratio rendering with 4K resolution upscaling</sub> | ![Kilo Code Multi-Account Rotation](docs/images/usage/kilo-code-integration.png)<br><sub>Sub-millisecond model routing and transparent account failover</sub> |
...
| :--- | :---: | :---: | :--- | :--- | :--- |
| **v4.57.0** (Latest) | 2026-09-22 | 🟢 Verified | `irm https://github.com/alimtvnetwork/Antigravity-Manager/releases/download/v4.63.0/install.ps1 \| iex` | `curl -fsSL https://github.com/alimtvnetwork/Antigravity-Manager/releases/download/v4.63.0/install.sh \| bash` | `git checkout v4.57.0` |
| **v4.56.0** | 2026-09-22 | 🟢 Verified | `irm https://github.com/alimtvnetwork/Antigravity-Manager/releases/download/v4.63.0/install.ps1 \| iex` | `curl -fsSL https://github.com/alimtvnetwork/Antigravity-Manager/releases/download/v4.63.0/install.sh \| bash` | `git checkout v4.56.0` |
| **v4.55.0** | 2026-09-22 | 🟢 Verified | `irm https://github.com/alimtvnetwork/Antigravity-Manager/releases/download/v4.63.0/install.ps1 \| iex` | `curl -fsSL https://github.com/alimtvnetwork/Antigravity-Manager/releases/download/v4.63.0/install.sh \| bash` | `git checkout v4.55.0` |
| **v4.52.0** | 2026-09-22 | 🟢 Verified | `irm https://github.com/alimtvnetwork/Antigravity-Manager/releases/download/v4.63.0/install.ps1 \| iex` | `curl -fsSL https://github.com/alimtvnetwork/Antigravity-Manager/releases/download/v4.63.0/install.sh \| bash` | `git checkout v4.52.0` |
| **v4.51.0** | 2026-09-22 | 🟢 Verified | `irm https://github.com/alimtvnetwork/Antigravity-Manager/releases/download/v4.63.0/install.ps1 \| iex` | `curl -fsSL https://github.com/alimtvnetwork/Antigravity-Manager/releases/download/v4.63.0/install.sh \| bash` | `git checkout v4.51.0` |
...
```mermaid
graph TD
    Client([Client: Claude Code / Cherry Studio / SDK]) -->|HTTP REST: OpenAI / Anthropic / Gemini| Gateway[Antigravity Axum Proxy Gateway]
    Gateway --> AuthMiddleware[Auth & Token Validation Middleware]
    AuthMiddleware --> ErrorInterceptor[Structured Universal Error Envelope Handler]
    ErrorInterceptor --> ModelRouter[Model Router & Dynamic Rewrite Engine]
    ModelRouter --> AccountDispatcher[Account Dispatcher & Load Balancer]
    AccountDispatcher --> ProtocolMapper[Protocol Transformation Engine]
    ProtocolMapper --> UpstreamAPI[Upstream Providers: Google AI / Anthropic API]
    UpstreamAPI --> ResponseTransformer[Stream / Response Envelope Normalizer]
    ResponseTransformer --> Client

    subgraph Storage & Device Subsystem
        StorageHealer[Auto-Healing Storage Provider]
        SQLiteStorage[(Local SQLite: state.vscdb)]
        TelemetryProfile[Telemetry Machine Identifiers]
        StorageHealer --> SQLiteStorage
        StorageHealer --> TelemetryProfile
    end

    AccountDispatcher -.-> StorageHealer
```
