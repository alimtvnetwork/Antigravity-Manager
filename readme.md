...
```powershell
# Install pinned release (e.g. v4.52.0)
irm https://github.com/alimtvnetwork/Antigravity-Manager/releases/download/v4.52.0/install.ps1 | iex
```

#### Linux & macOS (Bash)
```bash
# Install pinned release (e.g. v4.52.0)
curl -fsSL https://github.com/alimtvnetwork/Antigravity-Manager/releases/download/v4.52.0/install.sh | bash
```
