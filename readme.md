...
<p align="center">
  ...
  <a href="https://github.com/alimtvnetwork/Antigravity-Manager/releases">
    <img src="https://img.shields.io/badge/Version-4.44.1-3B82F6?style=flat-square" alt="Version 4.44.1">
  </a>
...
```powershell
# Install pinned release (e.g. v4.44.1)
irm https://github.com/alimtvnetwork/Antigravity-Manager/releases/download/v4.44.1/install.ps1 | iex
```

#### Linux & macOS (Bash)
```bash
# Install pinned release (e.g. v4.44.1)
curl -fsSL https://github.com/alimtvnetwork/Antigravity-Manager/releases/download/v4.44.1/install.sh | bash
```
