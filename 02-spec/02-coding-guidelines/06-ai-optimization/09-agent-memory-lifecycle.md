...
- **Deduplication:** AI agents must periodically scan `.ai-memory/memories/` for duplicated patterns or rules that have since been formalized into the `spec/` folder.
