...
CI_JOBS_MATRIX: dict[str, list[str]] = {
    ...
    "Relative Path Guard (.lovable)": [sys.executable, "03-ai-scripts/07-relative-path-fixer.py", ".lovable"],
    ...
    "Newline Styling Check (.lovable)": [sys.executable, "03-ai-scripts/04-newline-fixer.py", ".lovable"],
    ...
    "Encoding Normalizer Check (.lovable)": [sys.executable, "03-ai-scripts/10-encoding-normalizer.py", ".lovable"],
    ...
    "Markdown Gap Check (.lovable)": [sys.executable, "03-ai-scripts/31-md-gap-fixer.py", ".lovable"],
