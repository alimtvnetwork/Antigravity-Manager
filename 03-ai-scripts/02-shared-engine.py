...
# Centralized Grounded CI Quality Gate Job Definitions
CI_JOBS_MATRIX: dict[str, list[str]] = {
    ...
    "Sequence Integrity Linter": [sys.executable, "03-ai-scripts/21-sequence-integrity-linter.py"],
    "Doc Path Linter": [sys.executable, "03-ai-scripts/22-doc-path-linter.py"],
    "CLI Help Auditor": [sys.executable, "03-ai-scripts/09-cli-help-auditor.py"],
    "Relative Path Guard (.ai-memory)": [sys.executable, "03-ai-scripts/07-relative-path-fixer.py", ".ai-memory"],
    "Relative Path Guard (01-prompts)": [sys.executable, "03-ai-scripts/07-relative-path-fixer.py", "01-prompts"],
    "Relative Path Guard (.agents)": [sys.executable, "03-ai-scripts/07-relative-path-fixer.py", ".agents"],
    "Newline Styling Check (.ai-memory)": [sys.executable, "03-ai-scripts/04-newline-fixer.py", ".ai-memory"],
    "Newline Styling Check (01-prompts)": [sys.executable, "03-ai-scripts/04-newline-fixer.py", "01-prompts"],
    "Newline Styling Check (.agents)": [sys.executable, "03-ai-scripts/04-newline-fixer.py", ".agents"],
    "Newline Styling Check (03-ai-scripts)": [sys.executable, "03-ai-scripts/04-newline-fixer.py", "03-ai-scripts"],
    "Newline Styling Check (02-spec)": [sys.executable, "03-ai-scripts/04-newline-fixer.py", "02-spec"],
    "Encoding Normalizer Check (01-prompts)": [sys.executable, "03-ai-scripts/10-encoding-normalizer.py", "01-prompts"],
    "Encoding Normalizer Check (.ai-memory)": [sys.executable, "03-ai-scripts/10-encoding-normalizer.py", ".ai-memory"],
    "Encoding Normalizer Check (.agents)": [sys.executable, "03-ai-scripts/10-encoding-normalizer.py", ".agents"],
    "Encoding Normalizer Check (03-ai-scripts)": [sys.executable, "03-ai-scripts/10-encoding-normalizer.py", "03-ai-scripts"],
    "Boolean Naming Check (src)": [sys.executable, "03-ai-scripts/08-naming-autofixer.py", "src"],
    "Boolean Naming Check (03-ai-scripts)": [sys.executable, "03-ai-scripts/08-naming-autofixer.py", "03-ai-scripts"],
    "Boolean Naming Check (src-tauri)": [sys.executable, "03-ai-scripts/08-naming-autofixer.py", "src-tauri"],
    "Markdown Gap Check (01-prompts)": [sys.executable, "03-ai-scripts/31-md-gap-fixer.py", "01-prompts"],
    "Markdown Gap Check (.ai-memory)": [sys.executable, "03-ai-scripts/31-md-gap-fixer.py", ".ai-memory"],
