...
- **Target Files:**
  ...
  - `.lovable/release/release-notes-v4.15.0.md`
- **Accomplishments:**
  ...
  - Documented release highlights and quick-install one-liners in `.lovable/release/release-notes-v4.15.0.md`, `CHANGELOG.md`, and `CHANGELOG_EN.md`.
