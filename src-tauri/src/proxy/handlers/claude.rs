...
pub async fn handle_messages(
    ...
    // [Stage Timing] Stage timing measurement variables (ms, sub-millisecond precision)
    ...
    for attempt in 0..max_attempts {
        ...
        // Route request directly to client specified model, consistent with OpenAI protocol
        ...
        // [Stage 4 Timing] Waiting for Google upstream TTFT start time
