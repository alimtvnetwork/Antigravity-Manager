//! Windows Native Shell Shortcut Healer
//!
//! Native Win32 COM implementation for shortcut icon healing and shell cache refresh.
//! Operates in-process without invoking powershell.exe or external script interpreters.
...
/// Native Win32 COM shortcut icon healing and shell icon notification.
/// Scans desktop and Start Menu folders to ensure valid .exe icon paths.
#[cfg(target_os = "windows")]
...
/// Fallback stub for non-Windows platforms (Linux/macOS)
